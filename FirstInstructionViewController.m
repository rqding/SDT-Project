...
#import "FirstInstructionViewController.h"

@interface FirstInstructionViewController ()

@end

@implementation FirstInstructionViewController
...
- (void)viewDidLoad {
    ...
    NSString *introtext = [configDict objectForKey:@"main_intro"];
    ...
    [_FirstParagraphTextView setAttributedText:introstring];
