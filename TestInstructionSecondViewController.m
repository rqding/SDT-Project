//
//  TestInstructionSecondViewController.m
//  SMaLL
//
...
#import "TestInstructionSecondViewController.h"

@interface TestInstructionSecondViewController ()

@end

@implementation TestInstructionSecondViewController
...
- (void)viewDidLoad {
    ...
    //for TESTING only 2s !
    [NSTimer scheduledTimerWithTimeInterval:3.0f target:self selector:@selector(showNextButton) userInfo:nil repeats:NO];
